        ...
        <div class="flex items-center gap-8">
            ...
            <nav class="hidden md:flex items-center gap-6 text-sm tracking-widest font-serif">
                ...
                <a href="{{ route('koleksi') }}"
                    class="hover:text-yellow-500 transition-colors flex items-center gap-1">
                    KOLEKSI
                </a>
            ...
            <div class="flex flex-col h-full w-full p-8 relative z-10">
                ...
                <div class="flex justify-between items-center mb-16">
                    ...
                    <button @click="menuOpen = false"
                        class="text-gray-400 hover:text-yellow-500 focus:outline-none transition-transform hover:rotate-90 duration-300">
                ...
                <nav class="flex flex-col gap-6 text-2xl font-serif tracking-widest text-white">
                    ...
                    <div x-data="{ dropKoleksi: false }">
                        <button @click="dropKoleksi = !dropKoleksi"
                            class="flex items-center gap-2 hover:text-yellow-500 transition focus:outline-none w-full justify-between">
                            KOLEKSI
                            <svg :class="{ 'rotate-180': dropKoleksi }"
                        ...
                        <div x-show="dropKoleksi" x-transition.opacity
                            class="flex flex-col gap-3 mt-4 ml-4 text-lg text-gray-300 border-l border-gray-700 pl-4">
                    ...
                    <a href="{{ route('login') }}"
                        class="text-gray-500 hover:text-yellow-500 transition flex items-center gap-2 mt-4 border-t border-gray-800 pt-6">
