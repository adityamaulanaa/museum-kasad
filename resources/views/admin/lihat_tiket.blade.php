                ...
                <table class="w-full text-left table-auto">
                    <thead
                        ...
                        <tr>
                            ...
                            <th class="px-5 py-4 text-center">Sesi</th> 
                        ...
                        <template x-for="(t, index) in pagedItems" :key="t.unique_id">
                            <tr class="hover:bg-[#141414] transition-colors text-sm"
                                ...
                                <td class="px-5 py-4 font-mono font-bold"
                                    :class="t.status_internal === 'Sudah Check-in' ? 'line-through text-gray-600' : 'text-[#e2ca52]'"
                                ...
                                <td class="px-5 py-4 text-left space-y-0.5 text-gray-400 whitespace-nowrap">
                                ...
                                <td class="px-5 py-4 text-center">
                                    <span class="inline-block whitespace-nowrap px-2.5 py-1 rounded-full text-[9px] font-bold uppercase tracking-tighter"
                                        :class="t.status_internal === 'Sudah Check-in' ? 'bg-green-950/40 border border-green-800 text-green-400' : 'bg-yellow-950/40 border border-yellow-800 text-yellow-400'">
            ...
            <div @click.away="modalOpen = false"
                ...
                <div class="space-y-3 text-gray-300">
                    ...
                    <div class="grid grid-cols-2 gap-3 pt-2 border-t border-gray-800/40">
                        ...
                        <div><label class="text-[10px] font-bold text-gray-500 uppercase block">Sesi Kunjungan</label>
                            <p class="text-xs font-bold text-[#e2ca52]" x-text="selectedTiket?.sesi || '-'"></p>
                        </div>
                    </div>
                    <div class="pt-2">
                        <label class="text-[10px] font-bold text-gray-500 uppercase block">Metode Pembayaran</label>
