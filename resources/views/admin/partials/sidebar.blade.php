<aside :class="sidebarOpen ? 'translate-x-0 sm:w-64' : '-translate-x-full sm:translate-x-0 sm:w-20'"
    class="fixed top-0 left-0 z-50 h-full w-64 bg-[#111111] border-r border-gray-800 transition-transform duration-300 ease-in-out shrink-0 flex flex-col justify-between">
    ...
    <div class="p-3 border-t border-gray-800/60 bg-[#111111] shrink-0 mb-4">
        <a href="/" :class="sidebarOpen ? 'px-3 justify-start' : 'justify-center px-0'"
            class="flex items-center py-3 text-gray-500 hover:text-[#d4af37] hover:bg-[#151515] transition-all group rounded-xl">
            <i :class="sidebarOpen ? '' : 'mx-auto'"
                class="fas fa-arrow-left text-base w-5 text-center shrink-0 transition-transform group-hover:-translate-x-1"></i>
            <span class="ml-4 text-[11px] tracking-widest uppercase transition-all whitespace-nowrap"
                x-show="sidebarOpen">
                Website Utama
            </span>
        </a>
