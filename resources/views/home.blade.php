...
@section('content')
    <div x-data="{
        ...
        <template x-for="slide in slides" :key="slide">
            <div x-show="activeSlide === slide" x-transition:enter="transition-opacity ease-in-out duration-1000"
        ...
        <div class="absolute bottom-10 left-0 right-0 z-10 flex justify-center gap-3">
            <template x-for="slide in slides" :key="slide">
                <button @click="activeSlide = slide"
                    :class="{ 'w-8 bg-yellow-500': activeSlide === slide, 'w-3 bg-white/50 hover:bg-white': activeSlide !==
                            slide }"
